export function renderSharedModule() {
    return String.raw `
import { api, copyToClipboard, els, esc, formatBytes, formatTimeRemaining, formDataObject, getGlobalEnvironment, optionMarkup, pretty, renderMeta, setBtnLoading, showLoading, summarizeError, toast } from '/assets/ui/runtime.js'
