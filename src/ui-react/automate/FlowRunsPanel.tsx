    ...
    <div className={`dv-subpanel ${props.active ? 'active' : ''}`}>
      <div className="panel">
        ...
        <div className="run-toolbar">
          ...
          <select value={props.runStatusFilter} onChange={(event) => props.onRunStatusFilterChange(event.target.value)}>
                ...
                {expanded ? (
                  <div className="run-expanded" onClick={(event) => event.stopPropagation()}>
                    ...
                    <div className="action-toolbar">
                      <select value={props.actionStatusFilter} onChange={(event) => props.onActionStatusFilterChange(event.target.value)}>
                        <option value="">all statuses</option>
                        <option value="Succeeded">Succeeded</option>
                        <option value="Failed">Failed</option>
                        <option value="Running">Running</option>
