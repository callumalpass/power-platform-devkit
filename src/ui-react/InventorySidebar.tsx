...
export function InventorySidebar<T>(props: Props<T>) {
  const filtered = props.filter ? props.items.filter((item) => props.matchItem(item, props.filter.toLowerCase())) : props.items;
  ...
  return (
    <div className="inventory-sidebar">
      <div className="panel inventory-panel">
        ...
        <input type="text" className="entity-filter" placeholder={props.filterPlaceholder} value={props.filter} onChange={(event) => props.onFilterChange(event.target.value)} />
